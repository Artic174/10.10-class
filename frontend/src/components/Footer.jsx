          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-slate-300 text-sm">
                ...
                <span>tentenchexo@gmail.com</span>
              </div><a href="https://chat.whatsapp.com/EGAKfRTAiPDC1JgkLRc53K" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-slate-300 text-sm hover:text-yellow-400 transition-colors">
  <Phone className="h-4 w-4" />
  <span>WhatsApp Grup Kelas</span>
</a></div>
              <div className="flex items-center space-x-2 text-slate-300 text-sm">
                <MapPin className="h-4 w-4" />
                <span>SMK Negeri 1 Cicalengka - Kelas 10.10</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-700/50 mt-8 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              © 2025 Kelas 10.10 SMAN 1 Cicalengka. Dibuat dengan <Heart className="h-4 w-4 inline text-red-400" /> oleh murid-murid kelas.
            </p>
